...
class DDIMSampler(object):
    ...
    def make_schedule(self, ddim_num_steps, ddim_discretize="uniform", ddim_eta=0., verbose=True, num_ddpm_timesteps=600):
        self.ddim_timesteps = make_ddim_timesteps(ddim_discr_method=ddim_discretize, num_ddim_timesteps=ddim_num_steps,
                                                  num_ddpm_timesteps=num_ddpm_timesteps,verbose=verbose)

        print(self.ddim_timesteps, "ddim_timesteps")
    ...
    def sample(self,
        ...
        self.make_schedule(ddim_num_steps=S, ddim_eta=eta, verbose=verbose, num_ddpm_timesteps=ddpm_num_steps)
        # sampling
        C, H, W = shape
