...
from ldm.models.submodules import UpSampleBN, UpSampleGN, norm_normalize, sample_points
...
class Decoder(nn.Module):
    ...
    def forward(self, x_block4, x_block3, x_block2, x_block1, x_block0, gt_norm_mask=None, mode='test'):
